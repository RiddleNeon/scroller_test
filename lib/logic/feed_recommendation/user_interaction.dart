...
class UserInteraction {
  ...
  double get engagementScore =>
      calculateEngagementScore(liked: liked, disliked: disliked, shared: shared, commented: commented, saved: saved, completionRate: completionRate);

  double get normalizedEngagementScore => calculateNormalizedEngagementScore(engagementScore);

  @override
  String toString() {
    return 'UserInteraction(videoId: $videoId, authorId: $authorId, tags: $tags, watchTime: $watchTime, videoDuration: $videoDuration, liked: $liked, disliked: $disliked, shared: $shared, commented: $commented, saved: $saved, timestamp: $timestamp)';
  }
}
