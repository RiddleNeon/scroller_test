...
class SlideMorphTransitions {
  ...
  static Widget build(Animation<double> animation, Widget child, {Offset beginOffset = const Offset(0, 0.06), double beginScale = 0.985}) {
  ...
  static Widget switcher(Widget child, Animation<double> animation, {Offset beginOffset = const Offset(0, 0.12), double beginScale = 0.96}) {
    return build(animation, child, beginOffset: beginOffset, beginScale: beginScale);
  }
  ...
  static CustomTransitionPage<T> page<T>({
    ...
    return CustomTransitionPage<T>(
      ...
      transitionsBuilder: (context, animation, secondaryAnimation, pageChild) {
        return build(animation, pageChild, beginOffset: beginOffset, beginScale: beginScale);
      },
    );
  }
}
